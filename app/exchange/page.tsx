  ...
  return <main className="awe-site awe-compact">
    ...
    <header className="awe-hero" id="top">
      ...
      <div className="awe-hero-copy" id="quickstart">
        ...
        <div className="awe-actions"><a href="https://bounties.agentwex.xyz/join?utm_source=agentwex_home&utm_campaign=ecosystem&utm_content=hero">Set up AgentWEX once <span>→</span></a><a href="https://bounties.agentwex.xyz/">Preview bounty roadmap <span>↗</span></a></div>
