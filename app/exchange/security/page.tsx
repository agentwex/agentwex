...
export default function SecurityPage() {
  return <main className="awe-policy">
    ...
    <section><h2>Install safely</h2><p>For normal installation, run <code>npm install -g agentwex@0.6.3</code>, then <code>agentwex install</code>. The checksummed tarball is an optional manual-verification and recovery path—not an extra requirement. The preview supports macOS and Node.js 22.13 or newer.</p></section>
